...
@Component({
  selector: 'app-addleaveforhr',
  templateUrl: './addleaveforhr.component.html',
  styleUrls: ['./addleaveforhr.component.scss']
})
export class AddleaveforhrComponent implements OnInit{
  ...
  submit(){
    if(
      ...
      this.services.addleavehr(addForm).subscribe(response=>{
